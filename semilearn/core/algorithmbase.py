...
class AlgorithmBase:
    ...
    def __init__(
        ...
        self.lambda_uce = args.ulb_ce
        self.lambda_uim = args.ulb_im
        ...
        # build etfssl loss and unsupervised loss
        self.ce_loss = CELoss()
    ...
    def set_data_loader(self):
        ...
        loader_dict['lb_queue'] = get_data_loader(self.args,
                                                  self.dataset_dict['train_lb'],
                                                  self.args.eval_batch_size,
                                                  data_sampler=None,
                                                  num_workers=self.args.num_workers,
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for data_lb, data_ulb in zip(self.loader_dict['train_lb'],
                ...
                self.out_dict, self.log_dict, self.classpolars = self.train_step(
    ...
    def evaluate(self, eval_dest='eval', out_key='feat', return_logits=False):
        """
        evaluation function
        """
        self.model.eval()
        ...
        with torch.no_grad():
            for data in eval_loader:
                ...
                logits = torch.matmul(logits, self.classpolars)
