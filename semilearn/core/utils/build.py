...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    """
    from semilearn.datasets import  get_cifar, get_stl10, get_json_dset, get_pkl_dset
    ...
    if dataset in ["cifar10", "cifar100"]:
        ...
        test_dset = None
    # speech dataset
    elif dataset in ['superbks', 'urbansound8k']:
    ...
    elif dataset in ['amazon_review','yahoo_answers', ]:
