        ...
        if 'label' in batch:
            ...
            if len(s_features) > 0:
                ...
                if len(s_features_) > 0:
                    ...
                    return {'idx_ulb': batch['idx'], 'x_ulb_w': {'input_ids': batch['input_ids'], 'attention_mask': batch['attention_mask']}, 'x_ulb_s': {'input_ids': s_batch['input_ids'], 'attention_mask': s_batch['attention_mask']},'y_ulb':batch['lab']}
            else:
